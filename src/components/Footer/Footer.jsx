...
const Footer = () => {
	...
	const socials = [
		{
			username: "akashsingh7202@gmail.com",
			link: "mailto:akashsingh7202@gmail.com",
			icon: <Mail />,
			angle: -90,
		},
		{
			username: "@akashsingh0",
			link: "https://www.linkedin.com/in/akashsingh0/",
			icon: <Linkedin />,
			angle: -30,
		},
		{
			username: "@iakash-singh",
			link: "https://github.com/iakash-singh/",
			icon: <GitHub />,
			angle: 30,
		}
	];
